 ...
 */
var car, fuel, ground, trees = [], collidableTrees = [], numTrees = 0,
    collidableFuels = [];
...
function policeCar() {
    ...
    var frontLeftTire = createTire( 10, 10, 10, 32, Colors.brownDark, 30, -12, 15 );
    var frontRightTire = createTire( 10, 10, 10, 32, Colors.brownDark, 30, -12, -15 );
    var backLeftTire = createTire( 10, 10, 10, 32, Colors.brownDark, -30, -12, 15 );
    var backRightTire = createTire( 10, 10, 10, 32, Colors.brownDark, -30, -12, -15 );
    var blueSiren = createBox(15, 5, 15, Colors.darkBlue, 10, 35, 10);
    var whiteSiren = createBox(15, 8, 5, Colors.white, 10, 35, 0);
    var redSiren = createBox(15, 11, 15, Colors.redDark, 10, 35, -10);
    ...
    headLightRightLight.position.set( 60, 5, -15 );
...
function createGround() {
    ground = createBox( 2000, 20, 1000, Colors.greenDark, 0, -10, 0 );
    scene.add(ground);
}
